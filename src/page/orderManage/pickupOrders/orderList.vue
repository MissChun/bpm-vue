...
export default {
  ...
  methods: {
    ...
    goAddNewOder: function() {
      this.$router.push({ path: "/orderManage/pickupOrders/addNewPickUpOrder" });
    },
    changeF: function(type) {
      ...
      if (type != 'history') {
        this.$router.push({ path: "/orderManage/pickupOrders/ordersList?goTo=" + this.thisFifterName + "&st=" + type });
      } else {
        this.$router.push({ path: "/orderManage/pickupOrders/ordersList?goTo=" + this.thisFifterName });
      }
    },
    searchList: function() {
      var sendData = {};
    ...
    clickFifter: function(targetName) {
      ...
      //重新查询一次数据
      this.historyStatus = "";
      this.$router.push({ path: "/orderManage/pickupOrders?goTo=" + this.thisFifterName });
    },
    pageChange: function() {
      setTimeout(() => {
