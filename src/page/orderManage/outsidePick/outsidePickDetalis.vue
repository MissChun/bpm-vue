    ...
    <div class="nav-tab">
      <el-tabs v-model="activeName" type="card" @tab-click="clicktabs">
        <el-tab-pane label="外销单详情" name="first">
          <outside-pick-detali :back-link="'/orderManage/outsidePick/outsidePickList'"></outside-pick-detali>
  ...
  methods: {
    clicktabs: function(targetName) {
      if (targetName.name == 'second') {
        this.$router.push({ path: `/orderManage/outsidePick/outsidePickDetalisTab/outsidePickPoress/${this.outsidePickId}` });
      }
    },
