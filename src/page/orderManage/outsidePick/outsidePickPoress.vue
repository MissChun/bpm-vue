          ...
          <div class="detail-main border-top-clear">
            <el-container v-show="!pageLoading" style="min-height:200px;">
              <el-header>
                <el-row>
                  <el-col :span="3">
                    <router-link :to="{path: '/orderManage/outsidePick/outsidePickList'}">
  ...
  methods: {
    clicktabs: function(targetName) {
      if (targetName.name == 'first') {
        this.$router.push({ path: `/orderManage/outsidePick/outsidePickDetalisTab/outsidePickDetalis/${this.outsidePickId}` });
      }
    },
