...
export default {
  ...
  methods: {
    clicktabs: function(targetName) {
      ...
      this.$router.push({ path: "/orderManage/outsidePick/outsidePickList?goTo="+targetName.name+"&secondActiveName="+defaultTabls });
      this.reshCount();
    },
    reshCount:function(){
    ...
    changeTabs: function(fifterName) {
      ...
      this.$router.push({ path: "/orderManage/outsidePick/outsidePickList?goTo="+fifterName+"&secondActiveName=all" });
      this.reshCount();
    },
     childchangeTabs:function(tabsObj){
      //this.activeName = tabsObj.first;
      this.$router.push({ path: "/orderManage/outsidePick/outsidePickList?goTo="+tabsObj.first+"&secondActiveName="+tabsObj.second });
      this.reshCount();
    },
  },
   watch: {
