    ...
    <div class="nav-tab">
      <el-tabs v-model="activeName" type="card" @tab-click="clicktabs">
        <el-tab-pane label="外采单详情" name="first">
          <outside-buy-detali :back-link="'/orderManage/outsideBuy/outsideBuyList'"></outside-buy-detali>
  ...
  methods: {
    clicktabs: function(targetName) {
      if (targetName.name == 'second') {
        this.$router.push({ path: `/orderManage/outsideBuy/outsideBuyDetalisTab/outsideBuyPoress/${this.outsideBuyWaybillId}/${this.outsideBuyStedpId}` });
      }
    },
