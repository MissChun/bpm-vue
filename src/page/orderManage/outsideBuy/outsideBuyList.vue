...
export default {
  ...
  components: {
    outsidePickSecondMenu: () =>
      import ("../../../components/order/outsideBuy/outsideBuySecondMenu.vue")
  },
  data() {
    return {
      pageStatus: false,
  ...
  methods: {
    clicktabs: function(targetName) {
      ...
      this.$router.push({ path: "/orderManage/outsideBuy/outsideBuyList?goTo="+targetName.name+"&secondActiveName="+defaultTabls });
      this.reshCount();
    },
    reshCount:function(){
    ...
    changeTabs: function(fifterName) {
      ...
      this.$router.push({ path: "/orderManage/outsideBuy/outsideBuyList?goTo="+fifterName+"&secondActiveName=all" });
      this.reshCount();
    },
     childchangeTabs:function(tabsObj){
      //this.activeName = tabsObj.first;
      this.$router.push({ path: "/orderManage/outsideBuy/outsideBuyList?goTo="+tabsObj.first+"&secondActiveName="+tabsObj.second });
      this.reshCount();
    },
  },
   watch: {
