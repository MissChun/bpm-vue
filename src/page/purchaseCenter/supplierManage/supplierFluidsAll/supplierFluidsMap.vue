        ...
        function(MarkerList, SimpleMarker, SimpleInfoWindow, BasicControl) {
          ...
          _this.markerList = new MarkerList({
            ...
            getInfoWindow: function(data, context, recycledInfoWindow) {
              ...
              let infoBodyStr = '<div class="fs-13">所属供应商：' + data.supplier_name + '</div><div class="fs-13">实际液厂：' + data.actual_fluid + '</div><div class="fs-13">气种：' + gasType + '</div><br><div class="text-right "><a href="/#/purchaseCenter/supplierManage/supplierFluidsAll/supplierFluidsEditAdd?id=' + data.id + '" class="el-button el-button--primary el-button--mini">修改</a></div>';
