                    ...
                    <template slot-scope="scope">
                      ...
                      <div v-if="item.param === 'second_areas'">
                        <el-checkbox-group v-model="selectMenus">
                          <el-checkbox v-for="(area,index) in scope.row[item.param]" :label="area.id" :disabled="area.area_name==='中国'||area.area_name==='全国价'?true:false">{{area.area_name}}</el-checkbox>
                        </el-checkbox-group>
                      </div>
                    </template>
                  </el-table-column>
