  ...
  <div id="addPerson" class="detail-main">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="3">
            <router-link :to="{path: '/basicDataManage/supplierManage/supplierManageAll'}">
...
export default {
  ...
  methods: {
    ...
    goEditDetail: function(number) {
      this.$router.push({ path: "/basicDataManage/supplierManage/supplierManageAll/supplierManageEditAdd?activeStep=" + number + "&supplierId=" + this.supplierId+"&operate=edit"});
    },
