  ...
  methods: {
    ...
    goDetalis: function() {
      if (this.$route.query.operate === 'edit') {
        this.$router.push({
          path: `/basicDataManage/supplierManage/supplierManageAll/supplierManageDetalis/${ this.supplierId }/`
        });
      } else {
        this.$router.push({ path: "/basicDataManage/supplierManage/supplierManageAll" });
      }
    },
          ...
          this.$$http('upadteSupplierFrom', sendData).then((result) => {
            if (result.data.code == 0) {
              ...
              if (operation == 'out') {
                ...
                vm.$router.push({
                  path: "/basicDataManage/supplierManage/supplierManageAll/supplierManageEditAdd",
                  query: {
