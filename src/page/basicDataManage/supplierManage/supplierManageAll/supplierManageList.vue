...
export default {
  ...
  methods: {
    addSupplierManage: function() {
       window.open(`#/basicDataManage/supplierManage/supplierManageAll/supplierManageEditAdd`, '_blank')
      //this.$router.push({ path: "/basicDataManage/supplierManage/supplierManageAll/supplierManageEditAdd" });
    },
    ...
    jumpPage: function(scope) {
      if (scope.operator == "show") {
        ...
        window.open(`#/basicDataManage/supplierManage/supplierManageAll/supplierManageDetalis/${scope.rowData.id}/`, '_blank')
