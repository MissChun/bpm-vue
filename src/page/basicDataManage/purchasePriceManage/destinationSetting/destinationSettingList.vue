...
export default {
  ...
  methods: {
    checkLink(id, number) {
      //this.$router.push({ path: "/basicDataManage/purchasePriceManage/destinationSetting/editDestination", query: { id: id, activeStep: number } });
      window.open(`#/basicDataManage/purchasePriceManage/destinationSetting/editDestination?id=${id}&activeStep=${number}`, '_blank')
    },
    ...
    handleClick(tab, event) {
      if (tab.name === 'purchasePrice') {
        this.$router.push({ path: "/basicDataManage/purchasePriceManage/purchasePrice/purchasePriceList" });
      }
    },
    activated() {
