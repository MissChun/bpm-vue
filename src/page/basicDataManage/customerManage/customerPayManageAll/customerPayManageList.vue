...
export default {
  ...
  methods: {
    addCustomerPayManage: function() {
      // this.$router.push({ path: "/basicDataManage/customerManage/customerPayManageAll/customerPayManageEditAdd" });
      window.open(`#/basicDataManage/customerManage/customerPayManageAll/customerPayManageEditAdd`, '_blank');
    },
    clicktabs: function(targetName) {
      if (targetName.name == 'customerStation') {
        this.$router.push({ path: "/basicDataManage/customerManage/stationManageAll" });
    ...
    jumpPage: function(scope) {
      if (scope.operator == "show") {
        // this.$router.push({ path: "/basicDataManage/customerManage/customerPayManageAll/customerPayManageDetalis?customerPayId=" + scope.rowData.id });
        window.open(`#/basicDataManage/customerManage/customerPayManageAll/customerPayManageDetalis/${scope.rowData.id}/`, '_blank');
