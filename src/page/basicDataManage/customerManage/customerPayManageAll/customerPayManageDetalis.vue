...
export default {
  ...
  methods: {
    ...
    goEditDetail: function(number) {
      this.$router.push({ path: "/basicDataManage/customerManage/customerPayManageAll/customerPayManageEditAdd?activeStep=" + number + "&customerPayId=" + this.customerPayId +"&operate=edit"});
    },
