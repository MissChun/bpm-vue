...
export default {
  ...
  methods: {
    jumpPage(row) {
      // this.$router.push({
      //   path: '/basicDataManage/customerManage/stationManageAll/stationManageEditAdd',
      //   query: {
      //     id: row.rowData.id,
      //   }
      // })
      window.open(`#/basicDataManage/customerManage/stationManageAll/stationManageEditAdd?id=${row.rowData.id}`, '_blank');
    },
    addSite() {
      // this.$router.push({
      //   path: '/basicDataManage/customerManage/stationManageAll/stationManageEditAdd',
      // })
      window.open(`#/basicDataManage/customerManage/stationManageAll/stationManageEditAdd`, '_blank');
    },
    pageChange() {
      setTimeout(() => {
        this.getList();
    ...
    clicktabs: function(targetName) {
      if (targetName.name == 'customerManage') {
        this.$router.push({ path: "/basicDataManage/customerManage/customerManageAll/customerManageList" });
    ...
    clickChildtabs: function(targetName) {
      if (targetName.name == 'statationMap') {
        this.$router.push({ path: "/basicDataManage/customerManage/stationManageAll/stationManageMap" });
      }
    },
    customerList(query) {
      // if (query !== '') {
