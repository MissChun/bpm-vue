        ...
        function(MarkerList, SimpleMarker, SimpleInfoWindow, BasicControl) {
          ...
          _this.markerList = new MarkerList({
            ...
            getInfoWindow: function(data, context, recycledInfoWindow) {
              ...
              let infoBodyStr = '<div class="fs-13 md-5" >所属客户：' + owner_name + '</div><div class="fs-13 md-5">站点类型：' + data.station_type_display + '</div><div class="fs-13 md-5">实际站点名称：' + data.map_station_name + '</div><div class="fs-13 md-5">联系人：' + data.consignee + '</div><div class="fs-13 md-5">联系电话：' + data.consignee_phone + '</div><div class="fs-13 md-5">地址：' + data.address + '</div><div class="fs-13 ">启用状态：' + isActive + '</div><br><div class="text-right "><a href="/#/basicDataManage/customerManage/stationManageAll/stationManageEditAdd?id=' + data.id + '" class="el-button el-button--primary el-button--mini">修改</a></div>';
