...
export default {
        ...
        puchaseStatisticsDashboard: [
          //采购统计概览
          {
            dashboardSqureData: [{
              ...
              {
                key: "is_invoice_count",
                value: "未开票",
                goUrl: "/statistics/purchase/purchaseList?is_invoice=no",
                dimension: "车"
              }
            ],
            searchShow: false,
        ...
        salesStatisticsDashboard: [
          ...
          },
          {
            dashboardSqureData: [{
              ...
              {
                key: "is_reconciliation_noinvoice_count",
                value: "已对账未开票",
                dimension: "车",
                vLoading: false,
                extendTable: true
              ...
              {
                key: "is_reconciliation_invoice_count",
                value: "已对账已开票",
                dimension: "车",
                vLoading: false,
                extendTable: true
              ...
              {
                key: "humanize_is_invoice_not_back",
                value: "已开票已/未还款金额",
                dimension: "万",
                vLoading: false,
                extendTable: true
  ...
  methods: {
    clickExtendTable: function(backItem, isOnlySearch) {
      ...
      if (
        this.extendgetData &&
        this.extendgetData.key == backItem.key &&
        !isOnlySearch
      ) {
                  ...
                  if (results.data.code == 0) {
                    ...
                    setTimeout(() => {
                      var anchor = document.getElementById(
                        "extendTab-" + vm.extendgetData.key
                      );
